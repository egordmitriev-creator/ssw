...
import com.example.OrderManagementSystem.model.entity.*;
...
public class OrderServiceTest {
    ...
    void shouldFindOrdersByCustomerName() {
        ...
        AssertionsForClassTypes.assertThat(orders.get(0).getCustomer().getName()).isEqualTo("John Doe");
        AssertionsForClassTypes.assertThat(orders.get(1).getCustomer().getName()).isEqualTo("John Doe");
    }
    ...
    void shouldFindOrdersByAddress() {
        ...
        assertThat(orders).hasSize(2);
        AssertionsForClassTypes.assertThat(orders.get(0).getCustomer().getAddress().getCity()).isEqualTo("New York");
        AssertionsForClassTypes.assertThat(orders.get(1).getCustomer().getAddress().getCity()).isEqualTo("New York");
    }
    ...
    void shouldFindOrdersByPaymentType() {
        ...
        AssertionsForClassTypes.assertThat(orders.getFirst().getPayment()).isInstanceOf(Cash.class);
    }
    ...
    void shouldFindOrdersByOrderStatus() {
        ...
        assertThat(orders).hasSize(1);
        AssertionsForClassTypes.assertThat(orders.getFirst().getStatus()).isEqualTo("SHIPPED");
    }
    ...
    void shouldFindOrdersWithMultipleCriteria() {
        ...
        assertThat(orders).hasSize(1);
        AssertionsForClassTypes.assertThat(orders.getFirst().getCustomer().getName()).isEqualTo("John Doe");
        AssertionsForClassTypes.assertThat(orders.getFirst().getPayment()).isInstanceOf(Check.class);
    }
}
